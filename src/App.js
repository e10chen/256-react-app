...
function App() {
  return (
    ...
    </div><button id="copy" class="buttons">Copy</button><button id="toggleBackGroundColor" class="buttons">Change Background Color</button><button id="changeTitle" class="buttons">Change Title</button><button id="deleteButton" class="buttons">Delete Last Instance</button><div class="all">
        <header class="name">
